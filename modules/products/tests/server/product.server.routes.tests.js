    ...
    productObj.save(function () {
      request(app).get('/api/products/' + productObj._id)
        .end(function (req, res) {
          ...
          res.body.productTiers.should.be.instanceof(Array);
          res.body.productTiers[0].should.have.property('totalPrice');
          res.body.productTiers[0].totalPrice.should.equal(750000);
