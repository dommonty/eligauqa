 ...
 * Globals
 */
var app, agent, credentials, user, opportunity;
        ...
        agent.post('/api/opportunities')
          ...
          .end(function (opportunitySaveErr, opportunitySaveRes) {
            ...
            agent.get('/api/opportunities')
              .end(function (opportunitysGetErr, opportunitysGetRes) {
                // Handle Opportunity save error
                if (opportunitysGetErr) {
                  return done(opportunitysGetErr);
                }

                // Get Opportunities list
                var opportunities = opportunitysGetRes.body;
