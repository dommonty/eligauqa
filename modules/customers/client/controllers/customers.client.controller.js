(function () {
  ...
  CustomersController.$inject = ['$scope', '$state', 'Authentication', 'customerResolve', 'RegionsService'];

  function CustomersController ($scope, $state, Authentication, customer, RegionsService) {
    var vm = this;
