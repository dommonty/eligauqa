(function () {
  ...
  angular
    .module('reports')
    .controller('ReportBusinessUnitController', ReportBusinessUnitController);

  ReportBusinessUnitController.$inject = [ '$scope', 'BusinessunitsService', 'OutcometeamsService', 'OutcomesService',
    'SquadsService', 'EmployeesService', 'SquadoutcomesService', 'Authentication', 'SquadallocationsService', 'BusinessoutcomesService' ];

  function ReportBusinessUnitController($scope, BusinessunitsService, OutcometeamsService, OutcomesService,
                                        SquadsService, EmployeesService, SquadoutcomesService, Authentication, SquadallocationsService, BusinessoutcomesService) {
    var vm = this;
      ...
      angular.forEach(vm.allSquads, function (eachSquad) {
        angular.forEach(vm.allocations, function (eachAllocation) {
          ...
          if (eachAllocation.squad && eachAllocation.squad._id === eachSquad._id)
            vm.squadMembers[ eachSquad._id ].push(eachAllocation.employee);
        });
      });
    }
